...
**1. Клонируйте репозиторий:**
 ...
 ```bash
 git clone https://github.com/kirenate/lct.git #ссылка на ориг. репозиторий
 cd lct/pkg
 ```
...
- Backend: `Golang`, `REST API`, *подписанные ссылки для доступа к изображениям в объектном хранилище*
